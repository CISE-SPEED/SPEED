...
export default function Page() {
    return (
        <>
            ...
            <p>Whether you're a software engineer, researcher, or student, our platform gives you access to a curated database of empirical research on software engineering practices.</p>
